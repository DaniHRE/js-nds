...
function getBinaryPromise() {
  if (!wasmBinary && (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER)) {
    if ("function" == typeof fetch && !isFileURI(wasmBinaryFile))
      return fetch("https://github.com/DaniHRE/js-nds/blob/main/binary/desmond.wasm", { credentials: "same-origin" })
        .then(function (e) {
          if (!e.ok)
...
function createWasm() {
  ...
  return (
    ...
    "function" != typeof fetch
      ? n(r)
      : fetch("https://github.com/DaniHRE/js-nds/blob/main/binary/desmond.wasm", { credentials: "same-origin" }).then(
          function (t) {
...
isDataURI((wasmBinaryFile = "https://github.com/DaniHRE/js-nds/blob/main/binary/desmond.wasm")) ||
